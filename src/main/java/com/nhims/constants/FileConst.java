...
public class FileConst {
	...
	public static String ENVIRONMENT_PRODUCTION_FILE = MAIN_PATH
			+ "//src//test//resources//settings//production.properties";
	public static String ENVIRONMENT_NIGHTLIGHT_FILE = MAIN_PATH
			+ "//src//test//resources//settings//nightlight.properties";
}
