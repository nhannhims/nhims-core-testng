...
public class GenaralPage {
	private static Control txtSearch = new Control("//input[contains(@class,'js-searchKeywords')]");
	private static Control navMainMenu = new Control("//*[contains(@class,'header')]//a[text()='%s']");
	private static Control navChildMenu = new Control("//*[contains(@class,'header')]//a[text()='%s']/..//li//*[contains(text(),'%s')]");
